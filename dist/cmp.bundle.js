...
/******/ 		return __webpack_require__.p + "" + ({"vendors~ui":"vendors~ui","ui":"ui"}[chunkId]||chunkId) + ".chunk.bundle.js"
/******/ 	}
/******/
...
/******/ 	__webpack_require__.p = "https://pluto.mgr.consensu.org/";
/******/
...
/*!**********************!*\
  !*** ./package.json ***!
  \**********************/
/*! exports provided: name, version, description, main, scripts, repository, keywords, author, license, bugs, homepage, engines, dependencies, devDependencies, default */
/***/ (function(module) {

module.exports = {"name":"cmp","version":"0.3.0","description":"Consent Management Platform","main":"./server/server.js","scripts":{"start":"node ./server/server.js","develop":"NODE_ENV=development ASSET_PATH=/ webpack --mode development --watch","build:dev":"NODE_ENV=development ASSET_PATH=/ webpack --mode development","build:staging":"NODE_ENV=development ASSET_PATH=https://staging-dot-pluto-cmp.appspot.com/ webpack --mode development","build:prod":"NODE_ENV=development ASSET_PATH=https://pluto.mgr.consensu.org/ webpack --mode development","deploy":"NODE_ENV=production pm2 start ./server/server.js","storybook":"start-storybook -p 9001 -c .storybook"},"repository":{"type":"git","url":"git+https://github.com/orbislabs/cmp.git"},"keywords":["consent","management","cmp"],"author":"Dennis Yurkevich","license":"ISC","bugs":{"url":"https://github.com/orbislabs/cmp/issues"},"homepage":"https://github.com/orbislabs/cmp#readme","engines":{"node":"8.x"},"dependencies":{"@google-cloud/logging-winston":"^0.9.0","@vuikit/icons":"^0.8.1","@vuikit/theme":"^0.8.0","babel-polyfill":"^6.26.0","consent-string":"^1.2.4","cookie-parser":"^1.4.3","dotenv":"^6.0.0","express":"^4.16.3","js-cookie":"^2.2.0","uikit":"^3.0.0-beta.42","vue":"^2.5.16","vuex":"^3.0.1","vuikit":"^0.8.4","winston":"2.4.3"},"devDependencies":{"@babel/core":"^7.0.0-beta.51","@babel/plugin-transform-runtime":"^7.0.0-beta.51","@babel/preset-env":"^7.0.0-beta.51","@storybook/vue":"^4.0.0-alpha.14","babel-eslint":"^8.2.3","babel-loader":"^8.0.0-beta.2","babel-plugin-syntax-dynamic-import":"^6.18.0","babel-preset-env":"^1.7.0","clean-webpack-plugin":"^0.1.19","css-loader":"^0.28.11","eslint":"^4.19.1","eslint-config-airbnb-base":"^12.1.0","eslint-plugin-import":"^2.12.0","eslint-plugin-vue":"^4.5.0","html-loader":"^0.5.5","html-webpack-exclude-assets-plugin":"0.0.7","html-webpack-plugin":"^3.2.0","mini-css-extract-plugin":"^0.4.0","node-sass":"^4.9.0","sass-loader":"^7.0.3","sass-resources-loader":"^1.3.3","style-loader":"^0.21.0","uglifyjs-webpack-plugin":"^1.2.7","vue-loader":"^15.2.4","vue-style-loader":"^4.1.0","vue-template-compiler":"^2.5.16","webpack":"4.9.2","webpack-bundle-analyzer":"^2.13.1","webpack-cli":"^3.1.0"}};
...
var _consentString = __webpack_require__(/*! consent-string */ "./node_modules/consent-string/dist/index.js");

var _customVendors = _interopRequireDefault(__webpack_require__(/*! ./customVendors */ "./src/cmp/customVendors.js"));

var cookies = _interopRequireWildcard(__webpack_require__(/*! ../utils/cookies */ "./src/utils/cookies.js"));

var _iabVendorList = _interopRequireDefault(__webpack_require__(/*! ../configs/iabVendorList */ "./src/configs/iabVendorList.js"));

var _tagManager = _interopRequireDefault(__webpack_require__(/*! ./tagManager */ "./src/cmp/tagManager.js"));
...
var Cmp =
/*#__PURE__*/
function (_ConsentString) {
  _inherits(Cmp, _ConsentString);
  ...
  function Cmp() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Cmp).call(this, result.iabCookie));

    _this.setCmpId(52);

    _this.setCmpVersion(1);

    _this.setConsentLanguage('en');

    _this.setConsentScreen(1);

    _this.setGlobalVendorList(_iabVendorList.default);

    _this.clientId = result.clientId;
    _this.cmpLoaded = false;
    _this.customVendorsAllowed = (0, _customVendors.default)();
    return _this;
  }

  _createClass(Cmp, [{
    key: "readyCmpAPI",
    value: function readyCmpAPI() {
      this.cmpLoaded = true;
      console.log("[INFO][Module-CMP]: CMP loaded status is => ".concat(this.cmpLoaded));
      Promise.resolve();
    }
  }, {
    key: "ping",
    ...
    value: function getVendorConsents() {
      var _this2 = this;

      var vendors = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : allVendors;
      var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {};
      var result = {};
      vendors.forEach(function (element) {
        result[element] = _this2.isVendorAllowed(element);
      });
      callback(result, true);
    }
  }, {
    ...
    value: function getConsentData() {
      var empty = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {};
      var result = this.getConsentString();
      callback(result, true);
    }
  }, {
    key: "showConsentTool",
    value: function showConsentTool() {
      var _this3 = this;

      console.log('[INFO][CMP-Module] showConsentTool() has been called.');
      return new Promise(function (resolve, reject) {
        return Promise.all(/*! import() | ui */[__webpack_require__.e("vendors~ui"), __webpack_require__.e("ui")]).then(function() { var module = __webpack_require__(/*! ../ui/main */ "./src/ui/main.js"); return typeof module === "object" && module && module.__esModule ? module : Object.assign({/* fake namespace object */}, typeof module === "object" && module, { "default": module }); }).then(function (appModule) {
          return appModule.default(_this3.clientId);
        }).then(function (userConsentObject) {
          return _this3.updateCmpAndWriteCookie(userConsentObject);
        }).then(function () {
          return (0, _tagManager.default)();
        }).then(function () {
          return cookies.requestHttpCookies('euconsent', _this3.getConsentString());
    ...
    key: "setCustomVendorsAllowed",
    value: function setCustomVendorsAllowed(customVendorArray) {
      this.customVendorsAllowed = customVendorArray;
    }
  }, {
    key: "updateCmpAndWriteCookie",
    value: function updateCmpAndWriteCookie(consentObject) {
      var _this4 = this;

      return new Promise(function (resolve, reject) {
        _this4.setPurposesAllowed(consentObject.purposes);

        _this4.setVendorsAllowed(consentObject.vendors);

        _this4.setCustomVendorsAllowed(consentObject.customVendors);

        console.log('[INFO][Module-CMP]: Received consent object', consentObject);
        console.log("CMP => Set CustomVendors:".concat(JSON.stringify(_this4.customVendorsAllowed)));
        console.log("CMP => Set Purposes: ".concat(JSON.stringify(_this4.getPurposesAllowed())));
        console.log("CMP => Set Vendors: ".concat(JSON.stringify(_this4.getVendorsAllowed())));
        cookies.writeCookieCustom(JSON.stringify(consentObject.customVendors));
        cookies.writeCookie(_this4.getConsentString()).then(function (result) {
...
exports.default = getCustomVendorsAllowed;
...
exports.default = initCmp;

var _Cmp = _interopRequireDefault(__webpack_require__(/*! ./Cmp */ "./src/cmp/Cmp.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function initCmp(loaderData) {
  console.log('[INFO][Module-Loader]: ', loaderData);
  return new Promise(function (resolve, reject) {
    var cmp = new _Cmp.default(loaderData);
    if (!cmp) reject();
...
function _default(cookie) {
  var isCookiePresent = typeof cookie === 'string';
...
exports.default = tagManagerModule;
...
function updateConsentCookies(purposeArray) {
  for (var i = 0; i < purposeArray.length; i++) {
    if (map.get(purposeArray[i])) {
      _jsCookie.default.set(map.get(purposeArray[i]), true);
    }
  }
}
...
function tagManagerModule() {
  return new Promise(function (resolve, reject) {
    var purposeArray = cmp.getPurposesAllowed();
...
var iabVendorList = {
  ...
  "vendors": [{
    ...
    "id": 294,
    "name": "Jivox Corp",
    "policyUrl": "http://www.jivox.com/privacy",
    "purposeIds": [],
    "legIntPurposeIds": [1, 2, 3, 4, 5],
    "featureIds": [3]
  }, {
    ...
    "policyUrl": "https://peter.clipcentric.com/privacy05252018.bhtml",
    "purposeIds": [1, 3],
    "legIntPurposeIds": [5],
    "featureIds": [3]
  }, {
    ...
    "id": 238,
    "name": "StackAdapt",
    "policyUrl": "www.stackadapt.com/privacy",
    "purposeIds": [],
    "legIntPurposeIds": [1, 2, 3, 4, 5],
    "featureIds": [1, 2, 3]
  }, {
    "id": 284,
    "name": "WEBORAMA",
    "policyUrl": "https://weborama.com/fr/respect-de-la-vie-privee/",
    "purposeIds": [],
    "legIntPurposeIds": [1, 2, 3, 4, 5],
    "featureIds": [1, 2, 3]
  }, {
    ...
    "id": 339,
    "name": "Vuble",
    "policyUrl": "www.vuble.tv/us/privacy",
    "purposeIds": [2, 3, 4, 5],
    "legIntPurposeIds": [1],
    "featureIds": []
  }, {
    ...
    "policyUrl": "https://www.ultimedia.com/default/presentation/cgu",
    "purposeIds": [],
    "legIntPurposeIds": [1, 2, 3, 4, 5],
    "featureIds": [3]
  }, {
...
exports.default = initLoader;

var _getClientId = _interopRequireDefault(__webpack_require__(/*! ./utils/getClientId */ "./src/loader/utils/getClientId.js"));

var _isDataLayer = _interopRequireDefault(__webpack_require__(/*! ./utils/isDataLayer */ "./src/loader/utils/isDataLayer.js"));

var _package = _interopRequireDefault(__webpack_require__(/*! ../../package.json */ "./package.json"));

var _isCookie = __webpack_require__(/*! ./utils/isCookie */ "./src/loader/utils/isCookie.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function initLoader() {
  return Promise.all([(0, _getClientId.default)(), (0, _isDataLayer.default)(), (0, _isCookie.is1PCSupported)(), (0, _isCookie.is3PCSupported)(), (0, _isCookie.get1PCookieValue)('euconsent')] // cookie.get('1P','name');
  ).then(function (result) {
    // return {clientId, isDataLayer, is1PCSupported, is3PCSupported, iabCookie} = ...result
    return {
      appVersion: _package.default.version,
      // TODO: fetch this fro
      clientId: result[0],
...
function getClientID() {
  return new Promise(function (resolve, reject) {
    var scriptElement = document.getElementById('pluto-cmp-js-src');
    var clientId = scriptElement ? scriptElement.getAttribute('client-id') : 0;
...
exports.is1PCSupported = is1PCSupported;
exports.is3PCSupported = is3PCSupported;
exports.get1PCookieValue = get1PCookieValue;
...
function is3PCSupported() {
  return new Promise(function (resolve, reject) {
    ...
    frame.setAttribute('src', __webpack_require__.p + 'cookieCheckStart.html');
...
exports.default = isDataLayer;

// renameBug..
function isDataLayer() {
  return new Promise(function (resolve, reject) {
    var result = typeof dataLayer !== 'undefined' ? true : false;
    resolve(result);
  });
}
...
var _loader = _interopRequireDefault(__webpack_require__(/*! ./loader */ "./src/loader/index.js"));

var _cmp = _interopRequireDefault(__webpack_require__(/*! ./cmp */ "./src/cmp/index.js"));

var _api = _interopRequireDefault(__webpack_require__(/*! ./api */ "./src/api/index.js"));

var _isShowUi = _interopRequireDefault(__webpack_require__(/*! ./cmp/isShowUi */ "./src/cmp/isShowUi.js"));

var _tagManager = _interopRequireDefault(__webpack_require__(/*! ./cmp/tagManager */ "./src/cmp/tagManager.js"));
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _loader.default)();

          case 2:
            loaderData = _context.sent;
            _context.next = 5;
            return (0, _cmp.default)(loaderData);

          case 5:
            cmp = _context.sent;
            window.cmp = cmp; // TODO: remove this it should not be set globally

            (0, _api.default)(cmp).then(function () {
              return (0, _isShowUi.default)(loaderData.iabCookie);
            }).then(function (bool) {
              if (bool) cmp.showConsentTool();
              Promise.resolve(true);
            }).then(function (result) {
              return cmp.readyCmpAPI(result);
            }).then(function () {
              return (0, _tagManager.default)();
            }).catch(function (err) {
              return console.error(err);
...
exports.writeCookieCustom = writeCookieCustom;
exports.readCookieSync = readCookieSync;
exports.checkCookiesEnabled = checkCookiesEnabled;
exports.checkCookiesEnabledPromise = checkCookiesEnabledPromise;
exports.checkIabCookie = checkIabCookie;
exports.requestHttpCookies = requestHttpCookies;
...
function writeCookieCustom(value) {
  if (value !== '[]') {
    document.cookie = "custom=".concat(value).concat(COOKIE_DOMAIN, ";path=").concat(PATH, ";max-age=").concat(COOKIE_MAX_AGE);
  }
}
...
function requestHttpCookies(cookieName, cookieValue) {
  ...
  var url = __webpack_require__.p + 'api/setCookie';
  return new Promise(function (resolve, reject) {
    var headers = new Headers();
    headers.append('Content-Type', 'text/plain');
    headers.append('Accept', 'application/json');
    fetch("".concat(url, "?n=").concat(cookieName, "&c=").concat(cookieValue), {
      credentials: 'include',
      mode: 'cors',
      headers: headers
...
/******/ });
//# sourceMappingURL=cmp.bundle.js.map